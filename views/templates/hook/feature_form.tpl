	...
	<div class="translatable">
		{foreach $languages as $language}
			<div class="lang_{$language.id_lang}" style="display:{if $language.id_lang == $default_form_language}block{else}none{/if}; float: left;">
				...
				<p class="preference_description">{l s='When the Layered Navigation Block module is enabled, you can get more detailed URLs by choosing the word that best represent this feature. By default, thirty bees uses the feature\'s name, but you can change that setting using this field.' mod='blocklayered'}</p>
	...
	<div class="translatable">
		{foreach $languages as $language}
			<div class="lang_{$language.id_lang}" style="display:{if $language.id_lang == $default_form_language}block{else}none{/if}; float: left;">
				...
				<p class="preference_description">{l s='When the Layered Navigation Block module is enabled, you can get more detailed page titles by choosing the word that best represent this feature. By default, thirty bees uses the feature\'s name, but you can change that setting using this field.' mod='blocklayered'}</p>
			</div>
		{/foreach}
	</div>
</div>
